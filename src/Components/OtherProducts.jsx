    ...
    return(
        <div className="other-products-container">
            ...
            <div className="other-product-cards">
                <ProductCard image={twoLilyPic} productName="Lily of the Valley (2 Flowers)" price="$7.00"/>
                <ProductCard image={fourLilyPic} productName="Lily of the Valley (4 Flowers)" price="$12.00"/>
                ...
                <ProductCard image={lilyKeychainPic} productName="Lily of the Valley Keychain" price="$5.00"/>
